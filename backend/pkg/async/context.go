...
func RunAll(ctx context.Context, taskName string, fns ...func(ctx context.Context)) {
	...
	logger.DebugContext(
		newCtx, "all async tasks completed",
		zap.String("task", tc.TaskName),
